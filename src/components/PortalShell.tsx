...
const FEATURE_TO_LINK_MAP: Record<string, string[]> = {
  ...
  timetable: ['/admin/timetable', '/student/timetable', '/student/calendar', '/parent/timetable', '/teacher/timetable', '/faculty/timetable', '/hod/timetable'],
  ...
  exams: ['/admin/exams', '/student/exams', '/student/results', '/parent/results', '/teacher/results', '/faculty/cia', '/hod/exams'],
  exam_seating: ['/admin/exam/seating'],
  exam_enrollment: ['/admin/exam/enrollment'],
  ...
  faculty_portal: ['/faculty/dashboard'],
