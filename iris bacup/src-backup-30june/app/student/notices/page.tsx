...
import { Megaphone, MessageSquare, ShieldCheck, CheckSquare } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#C4B5FD]/70 font-light">Stay updated with general notifications, event dates, and academic schedules.</p>
          </div>
        </div>
