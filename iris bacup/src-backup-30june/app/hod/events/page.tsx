...
const mockEvents: DepartmentEvent[] = [
  {
    ...
    description: 'A 24-hour hackathon featuring teams from across the state competing on real-world problem statements sponsored by industry partners.',
    date: '2026-07-10',
    time: '09:00 AM - 09:00 AM (+1)',
    venue: 'Main Auditorium & Lab Block',
    organizer: 'Dr. Ananya Sharma',
    attendees: 180,
    category: 'Tech',
    status: 'upcoming',
  },
  {
    ...
    description: 'An evening of music, dance, and drama performances by students and faculty celebrating the diverse cultures within the department.',
    date: '2026-07-20',
    time: '06:00 PM - 10:00 PM',
    venue: 'Open Air Theatre',
    organizer: 'Prof. Suresh Iyer',
    attendees: 320,
    category: 'Cultural',
    status: 'upcoming',
  },
  {
    ...
    description: 'A week-long T20 cricket tournament between department teams with prizes for the winner, runner-up, and best player.',
    date: '2026-06-25',
    time: '04:00 PM - 07:00 PM',
    venue: 'College Cricket Ground',
    organizer: 'Coach Ravi Kumar',
    attendees: 95,
    category: 'Sports',
    status: 'upcoming',
  },
  {
    ...
    description: 'Industry expert from AWS discusses designing scalable microservices, container orchestration with Kubernetes, and serverless patterns.',
    date: '2026-06-18',
    time: '11:00 AM - 01:00 PM',
    venue: 'Seminar Hall 2',
    organizer: 'Dr. Kavitha Reddy',
    attendees: 110,
    category: 'Academic',
    status: 'upcoming',
  },
  {
    id: 'EVT-005',
    title: 'Workshop on Full-Stack Development with Next.js',
    description: 'Hands-on workshop covering React, Next.js App Router, server components, and deploying to Vercel. Bring your laptops!',
    date: '2026-06-15',
    time: '10:00 AM - 04:00 PM',
    venue: 'Computer Lab 3',
    organizer: 'Prof. Neha Gupta',
    attendees: 60,
    category: 'Workshop',
    status: 'upcoming',
  },
  {
    ...
    description: 'Two-day national conference with paper presentations, panel discussions, and keynotes from leading AI researchers.',
    date: '2026-05-28',
  ...
  },
  {
    ...
    description: 'Annual sports day featuring track events, relay races, badminton, and tug-of-war across faculty and student teams.',
    date: '2026-05-10',
