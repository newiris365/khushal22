...
logo_url TEXT,
plan_tier VARCHAR(50) DEFAULT 'Seed',
...
ALTER TABLE event_sponsors ADD COLUMN IF NOT EXISTS pipeline_stage VARCHAR(50) DEFAULT 'prospect';
...
ALTER TABLE event_budget ADD COLUMN IF NOT EXISTS type VARCHAR(20) DEFAULT 'expense';
...
ALTER TABLE attendance_sessions ADD COLUMN IF NOT EXISTS qr_rotate_interval INT DEFAULT 5;
...
ALTER TABLE attendance_sessions ADD COLUMN IF NOT EXISTS geo_radius INT DEFAULT 200;
...
ADD COLUMN IF NOT EXISTS person_type VARCHAR(20) DEFAULT 'visitor',
...
access_token TEXT,
template_namespace VARCHAR(200),
is_active BOOLEAN DEFAULT true,
